-- lua根据权重随机取值算法
-- https://www.jianshu.com/p/53b73ac0bfc2?utm_campaign=maleskine&utm_content=note&utm_medium=seo_notes&utm_source=recommendation
local Random = {}
...
do
    ...
    function Random.Get(m, n)
        ...
        if not randomtable then
            ...
            randomtable = {}
            for i = 1, tablesize do randomtable[i] = math.random() end
        end
...
function Random.GetRange(m, n, k)
    ...
    local result = {}
    for i = 1, k do result[#result + 1] = t[i] end
